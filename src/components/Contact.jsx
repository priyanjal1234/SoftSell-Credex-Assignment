      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Get a Free Valuation</h2>
          ...
          {submitted ? (
            <div className="bg-green-100 border border-green-400 text-green-700 px-6 py-8 rounded-lg mb-8 text-center">
              ...
              <p className="text-lg">Your message has been received. We'll contact you within 24 hours with a valuation.</p>
            </div>
          ) : (
            <form 
